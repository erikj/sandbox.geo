...
(function() {
  ...
  load_map = function(div_name) {
    var GOESCONUSIR, GOESEASTIR, GOESEASTVIS, GOESWESTIR, NEXRADBASEREFLECT, NEXRADN0Q, ames, eol_cgi, eol_cgis, eol_wms_layer, goes_east_ch1_latest, goes_east_ch3_latest, goes_east_ch4_latest, iowa_cgi, iowa_cgis, iowa_wms_layer, keyboardControl, layerSwitcher, map, navControl, osm, panZoomBar, _i, _j, _len, _len1;
    ...
    for (_j = 0, _len1 = eol_cgis.length; _j < _len1; _j++) {
      eol_cgi = eol_cgis[_j];
